...
const HTTP_PROVIDERS = {
  goerli: new HttpProvider(`https://goerli.ethrpc.test/${INFURA_PROJECT_ID}`),
  mainnet: new HttpProvider(`https://mainnet.ethrpc.test/${INFURA_PROJECT_ID}`),
  linea: new HttpProvider(`https://linea.ethrpc.test/${INFURA_PROJECT_ID}`),
  linea_goerli: new HttpProvider(
    `https://linea-goerli.ethrpc.test/${INFURA_PROJECT_ID}`,
  ),
  custom: new HttpProvider(
    `http://127.0.0.123:456/ethrpc?apiKey=foobar&somekey=someval`,
  ),
  palm: new HttpProvider(`https://palm.ethrpc.test/${INFURA_PROJECT_ID}`),
};
